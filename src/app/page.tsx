        ...
        <div className="px-4 sm:px-0">
          ...
          <div className="text-center mb-12 fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Welcome to <span className="royal-title glow-text">Lords of Esport</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="lords-card p-6 text-center fade-in">
              <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center mx-auto mb-4 pulse-glow">
                <Trophy className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Royal Competition</h3>
              <p className="text-gray-300">Elite tournament structure with substantial prize pools and pathways to legendary status.</p>
            </div>
            
            <div className="lords-card p-6 text-center fade-in">
              <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 to-teal-500 rounded-lg flex items-center justify-center mx-auto mb-4 pulse-glow">
                <Users className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Noble Alliance</h3>
              <p className="text-gray-300">Official partnership with VRXtra Kingston provides professional-grade facilities and royal treatment.</p>
            </div>
            
            <div className="lords-card p-6 text-center fade-in">
              <div className="w-12 h-12 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4 pulse-glow">
                <TrendingUp className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Ascend to Glory</h3>
              <p className="text-gray-300">Master Population One&apos;s revolutionary combat system and claim your throne in the virtual realm.</p>
            </div>
          </div>
