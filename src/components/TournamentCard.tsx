...
export default function TournamentCard({ tournament, onRegister, isRegistered }: TournamentCardProps) {
  ...
  return (
    <div className="tournament-card fade-in">
      <div className="p-6">
        {/* Header */}
        <div className="flex justify-between items-start mb-4">
          ...
          {tournament.prize_pool > 0 && (
            <div className="text-right">
              ...
              <div className="text-2xl font-bold royal-title">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          {tournament.entry_fee > 0 && (
            <div className="flex items-center text-gray-300">
              <span className="text-sm">Entry: <span className="text-cyan-400 font-semibold">£{tournament.entry_fee}</span></span>
            </div>
          )}
        </div>
        ...
        {tournament.status === 'registration_open' && (
          <div className="lords-card p-3 mb-4">
        ...
        <div className="flex gap-2">
          ...
          {tournament.status === 'completed' && (
            <button className="flex-1 btn-secondary px-4 py-2 rounded-lg font-medium transition-colors">
              View Results
            </button>
          )}
          
          <button className="btn-secondary px-4 py-2 rounded-lg font-medium transition-colors">
            Details
          </button>
        </div>
      </div>
